...
const NotificationsPage = () => {
  ...
  const defaultProfilePic = "https://api.dicebear.com/8.x/adventurer/svg?seed=default";
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <div className="avatar w-14 h-14 rounded-full bg-base-300">
                              <img
                                src={request.sender?.profilePic || defaultProfilePic}
                      ...
                      <div className="card-body p-4">
                        <div className="flex items-start gap-3">
                          <div className="avatar mt-1 size-10 rounded-full">
                            <img
                              src={notification.recipient?.profilePic || defaultProfilePic}
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm my-1">
                              {notification.recipient?.fullName || "This user"} accepted your friend request
                            </p>
